...
arrayX = np.load('arrays/LX.npy', allow_pickle=True)
arrayY = np.load('arrays/LY.npy',allow_pickle=True)
print("shape x", arrayX.shape)
...
Xtrain = z[:int((.8*len(z))),:90]
Ytrain = z[:int((.8*len(z))),90]
Xtest = z[int(0.8*len(z)):,:90]
Ytest = z[int(0.8*len(z)):,90]
